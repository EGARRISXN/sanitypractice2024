...
import {homePageQuery, pagesBySlugQuery, postBySlugQuery, settingsQuery} from '../lib/queries'
...
export function loadSettings() {
  return loadQuery(settingsQuery, {}, {next: {tags: ['settings', 'home', 'page', 'post']}})
}

export function loadHomePage() {
  return loadQuery(homePageQuery, {}, {next: {tags: ['home', 'post']}})
}

export function loadPost(slug) {
  return loadQuery(postBySlugQuery, {slug}, {next: {tags: [`post:${slug}`]}})
}
